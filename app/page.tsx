        ...
        {reviews.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {reviews.map((review: any) => (
              <Link href={`/${review.id}`} key={review.id} className="block h-full">
                <article className="group h-full relative bg-[#1a1d24] rounded-2xl overflow-hidden shadow-lg border border-gray-800/50 hover:border-purple-500/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-purple-500/10 flex flex-col">
